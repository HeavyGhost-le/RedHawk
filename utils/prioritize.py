#!/usr/bin/env python3
"""
Smart Subdomain Prioritization Utility
Analyzes wildcard scan results and categorizes targets by importance
"""
...
Phase 1 - Quick Assessment (30-60 minutes):
  Use GUI: Scan from List → top10_critical.txt

Phase 2 - Priority Targets (2-3 hours):
  Use GUI: Scan from List → top25_priority.txt

Phase 3 - Extended Analysis (5-8 hours):
  Use GUI: Scan from List → top50_targets.txt
    """)
    print("="*70 + "\n")
